...
// End Cross Module References
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_Singleton_MetaData[];
#endif
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_Singleton;
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ATetrisUSFX01GameModeBase_Statics::NewProp_Singleton_MetaData[] = {
		{ "Comment", "//Singleton\n" },
		{ "ModuleRelativePath", "TetrisUSFX01GameModeBase.h" },
		{ "ToolTip", "Singleton" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ATetrisUSFX01GameModeBase_Statics::NewProp_Singleton = { "Singleton", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ATetrisUSFX01GameModeBase, Singleton), Z_Construct_UClass_ASingletonObjeto_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ATetrisUSFX01GameModeBase_Statics::NewProp_Singleton_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ATetrisUSFX01GameModeBase_Statics::NewProp_Singleton_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ATetrisUSFX01GameModeBase_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ATetrisUSFX01GameModeBase_Statics::NewProp_Singleton,
	};
	...
	IMPLEMENT_CLASS(ATetrisUSFX01GameModeBase, 1817715);
