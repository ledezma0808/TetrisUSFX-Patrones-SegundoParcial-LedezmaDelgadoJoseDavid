...
#include "ConstructorBloqueColorido.generated.h"

UCLASS()
class TETRISUSFX01_API AConstructorBloqueColorido : public ABloqueGeneral, public IConstructorBloque
{
	GENERATED_BODY()
...
public:
	UPROPERTY(EditAnywhere, Category = "Materiales")
		class UMaterialInterface* MaterialColorido;
};
