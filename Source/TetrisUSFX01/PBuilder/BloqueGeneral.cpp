...
ABloqueGeneral::ABloqueGeneral()
{
	...
	MeshBloqueGeneral = CreateDefaultSubobject<UStaticMeshComponent>("Mesh Bloque general");
	RootComponent = MeshBloqueGeneral;
	...
	{
		MeshBloqueGeneral->SetStaticMesh(BlockFinder.Object);
	}
	else
	{
